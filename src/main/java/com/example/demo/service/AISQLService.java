...
public class AISQLService {
    ...
    public static String generateSQLPrompt(String naturalLanguageQuery) {
        return "你是一个专业的MySQL数据库专家，熟悉WMS仓库管理系统数据库结构。请根据用户需求生成准确的MySQL语句。\n\n" +
                ...
                "   - updated_at: 更新时间\n\n" +
                "输出要求：\n" +
                "1. 只返回一条纯净的SQL语句，不要包含任何解释、说明或其他文本\n" +
                "2. SQL语句必须以分号(;)结尾\n" +
                "3. 不要使用Markdown格式或其他格式化标记\n" +
                "4. 确保生成的SQL语句语法正确\n" +
                "5. 对于SELECT语句，如果涉及多个表，请使用适当的JOIN操作\n" +
                "6. 对于INSERT、UPDATE、DELETE语句，请确保符合表结构要求\n" +
                "7. 请确保WHERE条件准确，避免误操作数据\n" +
                "8. 不要在SQL语句后面添加任何解释性文字\n" +
                "9. 只返回一条SQL语句，不要返回多条\n" +
                "10. 不要包含任何中文说明或解释性文本\n" +
                "11. 不要包含'需要注意的是'、'根据问题描述'等解释性语句\n" +
                "12. 严格遵守以上规则，只输出SQL语句\n\n" +
                "示例输出：\n" +
